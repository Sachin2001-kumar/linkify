    ...
    <div className="flex flex-col items-center justify-center max-w-6xl mx-auto px-4 md:px-0">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {blogs.map((blog, id) => (
          <MagicCard
            key={id}
            className="p-0 md:p-0 relative bg-transparent shadow-none"
          >
            <Link
            ...
            <Card className="group border-0 bg-transparent shadow-none">
              <CardContent className="p-4 lg:p-6 bg-transparent">
                <div className="flex items-center justify-center h-40 lg:h-52 overflow-hidden rounded-lg">
                  <Image
                    src={blog.image}
                    alt={blog.title}
                    width={1024}
